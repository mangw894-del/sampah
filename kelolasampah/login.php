...
<head>
    ...
    <title>Login Multi User - Kelola Sampah</title>
...
<body>
    <div class="login-container">
        <h2 class="text-3xl font-bold text-green-700 mb-6 text-center">Login Kelola Sampah</h2>
        ...
        <form action="admin.php" method="post" class="space-y-5">
            ...
            <button type="submit" class="w-full text-white font-semibold py-3 rounded-md">Login</button>
        </form>

        <p class="mt-6 text-center text-green-700 font-semibold">
            Belum punya akun? <a href="daftar.php" class="underline hopver:text-green-900">Daftar di sini</a>
        </p>
    </div>
</body>
</html>
